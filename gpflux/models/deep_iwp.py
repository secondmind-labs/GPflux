...
import gpflux
from gpflux.layers import LayerWithObservations, SampleBasedGaussianLikelihoodLayer, FeaturesToKernelARD


class DeepIWP(Module):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.kernelizer = FeaturesToKernelARD(num_inducing, input_dim, epsilon=default_jitter())
    ...
    def _evaluate_deep_iwp(
        ...
        features = self.kernelizer(features)
    ...
    def elbo(self, data: Tuple[TensorType, TensorType], T: float = 1.) -> tf.Tensor:
        """
