...
class BayesianModel(tf.keras.Model):
    def __init__(self, X_input, Y_input, F_output, likelihood_layer, num_data):
    ...
    def predict_f(self, X: InputData):
        return self.predict(X)[0]

    def predict_y(self, X: InputData):
