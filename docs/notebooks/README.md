...
To make Notebooks easier to work with, they are stored as `.py` files in `gpflux/docs/notebooks`, and only converted to 
...
## Including your Notebook in GPflux's Sphinx-built doc set

Open `gpflux/docs/tutorials.rst` and insert a TOC entry for the Notebook, for example:
...
Then, build the docs as detailed in `gpflux/docs/README.md`.
