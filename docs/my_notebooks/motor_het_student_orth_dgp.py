...
if __name__ == '__main__':
    ...
    config = Config(
        num_inducing_u=NUM_INDUCING, num_inducing_v=NUM_INDUCING, inner_layer_qsqrt_factor=INNER_LAYER_QSQRT_FACTOR, likelihood_noise_variance=1e-2, whiten=True, underlying_kernel=SquaredExponential, likelihood = "StudentT"
    )
    ...
    filename = f"OrthDGP(layers:{len(deep_gp.f_layers)},units:{deep_gp.f_layers[0].num_latent_gps},lik.:HetStudentT)"
