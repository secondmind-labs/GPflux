...
full_test:
	pytest --cov=gpflux2 --cov-report html:cover_html -v --tb=short --junitxml=reports/junit.xml --cov-config .coveragerc --cov-report term --cov-report xml tests_gpflux2 --cov-fail-under=97
build:
	tox
#profile:
