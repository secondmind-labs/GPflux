...
requirements = [
    ...
    "numpy",
    "scipy",
    "tensorflow>=2.5.0,<2.10.0; platform_system!='Darwin' or platform_machine!='arm64'",
    # NOTE: Support of Apple Silicon MacOS platforms is in an experimental mode
    "tensorflow-macos>=2.5.0,<2.10.0; platform_system=='Darwin' and platform_machine=='arm64'",
